            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Voleybol</li>
                    </ul>
                </div>
            </div>
        </div>
                            ...
                            <div class="shipping-method-box">
                                ...
                                <div class="mb-4">
                                    <div class="custom-control custom-radio">
                                        <input id="shippingOption1" name="shipping-option" class="custom-control-input" checked="checked" type="radio" value="Voleybol_1">
                                        <label class="custom-control-label" for="shippingOption1">Voleybol</label> <span class="float-right font-weight-bold">Saatlik 250 tl</span> </div>
                                    <div class="ml-4 mb-2 small">(Haftada 5 saat)</div>
                                    <div class="custom-control custom-radio">
                                        <input id="shippingOption2" name="shipping-option" class="custom-control-input" type="radio" value="Voleybol_2">
                                        <label class="custom-control-label" for="shippingOption2">Voleybol</label> <span class="float-right font-weight-bold" >Saatlik 225 tl</span> </div>
                                    <div class="ml-4 mb-2 small">(Haftada 8 saat)</div>
                                    <div class="custom-control custom-radio">
                                        <input id="shippingOption3" name="shipping-option" class="custom-control-input" type="radio" value="Voleybol_3">
                                        <label class="custom-control-label" for="shippingOption3">Voleybol</label> <span class="float-right font-weight-bold">Saatlik 200 tl</span> </div>
