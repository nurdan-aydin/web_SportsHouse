        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        <h1>Galerimiz</h1>
                        <p>Başarılarımız. Bugünlere kadar neler yaptık.. </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row special-list">
                <div class="col-lg-3 col-md-6 special-grid bulbs">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/galeri_01.jpg" class="img-fluid" alt="Image">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 special-grid fruits">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/galeri_02.jpg" class="img-fluid" alt="Image">
                        </div>                        
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 special-grid bulbs">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/galeri_03.jpg" class="img-fluid" alt="Image">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 special-grid fruits">
                    <div class="products-single fix">
                        <div class="box-img-hover">                            
                            <img src="images/galeri_04.jpg" class="img-fluid" alt="Image">
                        </div>                        
                    </div>
                </div>
				<div class="col-lg-3 col-md-6 special-grid bulbs">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/galeri_05.jpg" class="img-fluid" alt="Image">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 special-grid fruits">
                    <div class="products-single fix">
                        <div class="box-img-hover">                            
                            <img src="images/galeri_06.jpg" class="img-fluid" alt="Image">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 special-grid podded-vegetables">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/galeri_07.jpg" class="img-fluid" alt="Image">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 special-grid root-and-tuberous">
                    <div class="products-single fix">
                        <div class="box-img-hover">                            
                            <img src="images/galeri_08.jpg" class="img-fluid" alt="Image">
                        </div>                        
                    </div>
                </div>
				...
				<div class="col-lg-3 col-md-6 special-grid root-and-tuberous">
                    <div class="products-single fix">
                        <div class="box-img-hover">                            
                            <img src="images/galeri_09.jpg" class="img-fluid" alt="Image">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 special-grid podded-vegetables">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/galeri_10.jpg" class="img-fluid" alt="Image">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 special-grid root-and-tuberous">
                    <div class="products-single fix">
                        <div class="box-img-hover">                           
                            <img src="images/galeri_11.jpg" class="img-fluid" alt="Image">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 special-grid podded-vegetables">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            <img src="images/galeri_12.jpg" class="img-fluid" alt="Image">
                        </div>                        
                    </div>
                </div>
            </div>
